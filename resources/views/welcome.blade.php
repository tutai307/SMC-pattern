    ...
    <header class="px-4 py-3 md:px-6 md:py-4 border-b border-white/10 bg-[#0a0e17]/80 sticky top-0 z-50 backdrop-blur-md">
        ...
        <div class="flex justify-between items-center">
            <div class="flex items-center gap-2 md:gap-4">
                ...
                <a href="{{ route('visitors') }}" class="hidden sm:flex px-3 py-1 bg-emerald-500/10 text-emerald-400 text-[10px] font-bold rounded-lg border border-emerald-500/20 hover:bg-emerald-500/20 transition-all items-center space-x-1">
